...
const defs: SkillDef[] = [
  ...
  },
  {
    ...
    text: "Deal 120% Magic Power magical damage and reduce the enemy's Magic Resist by 20% for 2 turns.",
  },
  {
    id: 'shadow_bolt',
    name: 'Shadow Bolt',
    ...
    element: 'dark',
    effects: [{ kind: 'damage', power: 200 }],
    text: 'Deal 200% Magic Power magical damage.',
  },
  {
    id: 'purging_strike',
    name: 'Purging Strike',
    ...
    tier: 'bronze',
    effects: [{ kind: 'damage', power: 180 }],
    text: 'Deal 180% of your higher power stat as TRUE damage — ignores Armor and Magic Resist.',
  },
  {
    id: 'purify',
    name: 'Purify',
