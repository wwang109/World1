> **HISTORICAL** — accurate as of its date; superseded by `src/data/skills.ts` (the shipped 72-card book). Never cite as current. DONE 2026-07-29 — this plan was executed in full.
