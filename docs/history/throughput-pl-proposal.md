> **HISTORICAL** — accurate as of its date; superseded by `docs/power-level-reference.md` and `docs/history/pl-changelog.md`. Never cite as current. PARTIALLY ADOPTED despite the "NOT adopted" header below: stun 100, negate 100, and guard parity were later adopted (2026-07-19 pass) — see the PL changelog.
