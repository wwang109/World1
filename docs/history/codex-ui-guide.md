> **HISTORICAL** — accurate as of its date; superseded by `docs/ui-workbook.md` and `docs/architecture.md`. Never cite as current. Describes the deleted first-gen UI (PrepScene hub, 720×1280 portrait, `?view=` routes).
