> **HISTORICAL** — accurate as of its date; superseded by `docs/run-structure.md` and `docs/design-locked.md`. Never cite as current. Internally contradictory after the 2026-07-30 ENDLESS revision (the WAVE 1..5 → BOSS → VICTORY diagram and depth-10 DAG predate it); the locked-decision rows were extracted to the register.
